...
const Header = () => {
  ...
  return (
    <header className="fixed rounded-t-2xl bottom-0 md:sticky md:top-0 z-50 w-full md:border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <TopBar />
